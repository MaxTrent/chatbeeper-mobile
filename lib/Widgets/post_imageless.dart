...
class _PostBeepState extends State<PostBeep> {
  ...
  Widget build(BuildContext context) {
        ...
        builder: (context) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(
                    bottom: 0.h, left: 59.w, right: 60.w, top: 37.h),
                child: Row(
    ...
    buildCollapsed2() {
      return Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                left: 30.w, right: 19.w, top: 20.h, bottom: 15.h),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                GestureDetector(
    ...
    Padding(
        padding:
            EdgeInsets.only(left: 30.w, right: 19.w, top: 20.h, bottom: 15.h),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
          children: [
            GestureDetector(
            ...
            GestureDetector(
              ...
              child: _rebeeped == false
                  ? SvgPicture.asset('images/rebeep.svg')
                  : SvgPicture.asset(
                      'images/rebeep.svg',
                      color: Colors.red,
                    ),
