...
class _PostCommentState extends State<PostComment> {
    ...
    buildCollapsed2() {
      return FutureBuilder(
        ...
        builder: ((BuildContext ctx,
                AsyncSnapshot<List<GetComment>> snapshot) =>
            Column(
              children: [
                Padding(
  ...
  Future<List<GetComment>> getComment() async {
    ...
    if (response.statusCode == 200) {
      ...
      List<GetComment> commentDetails = [];
      for (var comments in data) {
        GetComment commentDetail = GetComment(
          text: comments['text'],
          beepsCount: comments['beepsCount'],
          dislikesCount: comments['dislikesCount'],
          likesCount: comments['likesCount'],
          media: comments['media'],
          rebeepsCount: comments['comments'],
