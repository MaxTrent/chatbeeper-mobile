...
class _SignInState extends State<SignIn> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Welcome Back', style:Theme.of(context).primaryTextTheme.headline4!.copyWith(fontSize: 32.sp),),
                SizedBox(height: 32.h,),
                      ...
                      Row(
                        ...
                        children: [
                          RichText(text:TextSpan(
                            text: 'Forgot password?', style:  TextStyle(fontWeight: FontWeight.w500,color:bcolor4, fontSize: 18.sp, fontFamily: 'Nunito'),
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                              backgroundColor: MaterialStateProperty.resolveWith<Color>(
                                    ...
                                    if (_userTextController.text.isEmpty || _passwordTextController.text.isEmpty ) {
                                      return uColor;
  ...
  Future<void> logIn() async{
    if(_formKey.currentState!.validate() &&_userTextController.text.isNotEmpty && _passwordTextController.text.isNotEmpty){
      final response = await http.post(Uri.https('beeperchat.herokuapp.com', 'auth/login'),
          body: ({
