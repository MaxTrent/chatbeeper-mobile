  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Padding(
        ...
        child: Center(child: Text('Authentication Succesful',style: Theme.of(context).primaryTextTheme.subtitle2!.copyWith(fontSize: 22.sp,), textAlign: TextAlign.center,)),
      ),
          Center(
            child: Center(
              child: Text(
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                ...
                width: 292.w,
                decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage('images/authsucces.png',),
                      fit: BoxFit.contain
                  ),),
              ),
            ),
