...
class _NotificationsState extends State<Notifications> {
  ...
  String imageUrl = 'images/sarah.png';
  String notificationName = 'Amber Lexy';
  String notificationAction = 'and 4 others liked your beep';
  ...
  Widget build(BuildContext context) {
    ...
    String time = '1 minute ago';
    bool _followBack = false;
    return Scaffold(
