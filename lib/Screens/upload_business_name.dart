                  ...
                  child: Padding(
                    ...
                    child:       Padding(
                      ...
                      child: Column(
                        ...
                        children: [ //logo
                          SizedBox(width:width, height: 67.h,
                            child:   Row(
                              ...
                              children: [
                                RichText(
                                  text: TextSpan(
                                      text: '',
                                      children: [
                                        TextSpan(text: 'Skip',style: TextStyle( color: bcolor1, fontFamily: 'Nunito', fontWeight: FontWeight.w700, fontStyle: FontStyle.normal, fontSize: 18.sp),
                                          recognizer: TapGestureRecognizer()..onTap=()=>Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ChooseUsername(),
                                          ),),
                                        ),
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField<String>(
                              decoration:  InputDecoration(
                                contentPadding: EdgeInsets.only(top: 20.h,left: 10.w),
                              ...
                              hint:  Text('Select Document', style:  TextStyle(
                                  color: Colors.grey.shade400,
                                  fontFamily: 'Nunito',
                                  fontSize: 20.sp,
                                fontWeight: FontWeight.normal
                              ),),
                              items: <String>['CAC', 'International Passport',].map((String value) {
                          ...
                          Row(
                            children:  [
                               Expanded(
                                ...
                                child: SizedBox(
                                  height: 40, width: 155,
                                  child: Text('JPG,JPEG or PNG only \n(MAX, 500KB)',
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: Opacity(
                                ...
                                child: ElevatedButton(
                                  style: ButtonStyle(
                                      backgroundColor: MaterialStateProperty.all(bcolor3),
                                      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                          RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(40.0.r),
                                            side: const BorderSide(color: Colors.transparent),
                            ...
                            children: [
                              RichText(
                                text: TextSpan(
                                    text: '',
                                    children: [
                                      TextSpan(text: 'By creating an account you agree with our',style: TextStyle( color: Colors.black87, fontFamily: 'Nunito', fontWeight: FontWeight.w400, fontStyle: FontStyle.normal, fontSize: 18.sp),),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 5.w,),
                                  Text('and', style:TextStyle( color: Colors.black, fontFamily: 'Nunito', fontWeight: FontWeight.w400, fontStyle: FontStyle.normal, fontSize: 18.sp),),
                                  SizedBox(width: 5.w,),
                                  RichText(
                                    text: TextSpan(
                                        text: '',
                          ...
                          SizedBox(
                            width: 390.w, height: 29.h,
                            child: Row(
                              children: [
                                Padding(
                                  padding:  EdgeInsets.only(left:45.w,right: 30.w),
                                  child: Container(color: Colors.black, width: 100.w, height: 0.7.h,),
                                ),
                                Padding(
                                  padding:  EdgeInsets.only(right: 15.w),
                                  child: SizedBox(
                                      height: 28.h,width: 40.w,
                                      child: Center(child: Text('or', style: TextStyle(color:Colors.grey,fontSize: 24.sp, fontFamily: 'Ubuntu', fontWeight: FontWeight.w400),))),
                                ),
                                Container(color: Colors.black, width: 110.w, height: 0.7.h,),
                              ],
                            ),
                          ),//or
                          SizedBox(height: 48.h, width: 111.w,
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.asset('images/google.png', height: 35.h,width: 35.w,),
                                SizedBox(height:48.h, width:48.w, child: IconButton(onPressed: null, icon:Icon(FontAwesomeIcons.facebookSquare, color: bcolor3,size: 30.h,),))
                              ],
                            ),
                          ),//google and fb
                          Row(
                            ...
                            children: [
                              RichText(
                                text: TextSpan(
                                    text: '',
                                    children: [
                                      TextSpan(text: 'Already have an account?',style: TextStyle( color: Colors.black87, fontFamily: 'Nunito', fontWeight: FontWeight.w500, fontStyle: FontStyle.normal, fontSize: 18.sp),),
                                      TextSpan(
                                        text: ' Sign In',style:  TextStyle(color: bcolor1, fontStyle: FontStyle.normal, fontWeight: FontWeight.w700, fontSize: 18.sp),
